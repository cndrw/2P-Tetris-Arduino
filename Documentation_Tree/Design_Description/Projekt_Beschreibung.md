...
Hierbei wird mit einem High-Signal (5V) Puls auf dem Latch Pin die Abfrage gestartet. Daraufhin wird ein Clock-Signal erstellt das von High (5V) zu Low (0V) wechselt. Hierbei wird im Hintergrund, vom Mikrocontroller, mitgezählt welcher Clockpuls in Abhängigkeit der Zeit auftritt. 
